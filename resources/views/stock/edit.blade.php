      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <h4 class="card-title">Ubah Data Stock</h4>
            <div class="ml-auto">
            </div>
              ...
              <form action="{{ route('stock.update', $stock->id) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="kodebrg" name="kodebrg" autofocus>
                    ...
                    <option value="<?= $br['kodebrg'] ?>" {{ $stock->kodebrg == $br['kodebrg'] ? 'selected' : '' }} ><?= $br['namabrg'] ?></option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
                  <label for="qtybeli">Jumlah Beli</label>
                  <input type="number" class="form-control" id="qtybeli" name="qtybeli" placeholder="Jumlah Beli" value="{{ $stock->qtybeli }}" autofocus>
                </div>
