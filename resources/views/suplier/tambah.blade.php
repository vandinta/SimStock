            ...
            <div class="col-md-6 col-lg-12">
              <form action="{{ route('suplier.store') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kodespl" name="kodespl" placeholder="Kode Suplier" value="{{ old('kodespl') }}" autofocus>
                </div>
                <div class="form-group">
                  <label for="namaspl">Nama Suplier</label>
                  <input type="text" class="form-control" id="namaspl" name="namaspl" placeholder="Nama Suplier" value="{{ old('namaspl') }}" autofocus>
                </div>
